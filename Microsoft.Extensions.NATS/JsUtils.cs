namespace Microsoft.Extensions.NATS
{
    ...
    public static class JsUtils
    {
        ...
        public static bool StreamExists(IConnection c, string streamName) => GetStreamInfoOrNullWhenNotExist(c.CreateJetStreamManagementContext(), streamName) != null;

        public static bool StreamExists(IJetStreamManagement jsm, string streamName) => GetStreamInfoOrNullWhenNotExist(jsm, streamName) != null;
        ...
        public static StreamInfo CreateStream(IJetStreamManagement jsm, string stream, params string[] subjects) => CreateStream(jsm, stream, StorageType.Memory, subjects);

        public static StreamInfo CreateStream(IConnection c, string stream, params string[] subjects) => CreateStream(c.CreateJetStreamManagementContext(), stream, StorageType.Memory, subjects);

        public static StreamInfo CreateStreamExitWhenExists(IConnection c, string streamName, params string[] subjects) => CreateStreamExitWhenExists(c.CreateJetStreamManagementContext(), streamName, subjects);
        ...
        public static void CreateStreamWhenDoesNotExist(IConnection c, string stream, params string[] subjects) => CreateStreamWhenDoesNotExist(c.CreateJetStreamManagementContext(), stream, subjects);
        ...
        public static StreamInfo CreateStreamOrUpdateSubjects(IJetStreamManagement jsm, string streamName, params string[] subjects) => CreateStreamOrUpdateSubjects(jsm, streamName, StorageType.Memory, subjects);

        public static StreamInfo CreateStreamOrUpdateSubjects(IConnection c, string stream, params string[] subjects) => CreateStreamOrUpdateSubjects(c.CreateJetStreamManagementContext(), stream, StorageType.Memory, subjects);

        // ----------------------------------------------------------------------------------------------------
        // PUBLISH
        // ----------------------------------------------------------------------------------------------------
        public static void Publish(IConnection c, string subject, int count) => Publish(c.CreateJetStreamContext(), subject, "data", count, false);

        public static void Publish(IJetStream js, string subject, int count) => Publish(js, subject, "data", count, false);
